...
// The copy() method copies data from one buffer to another buffer.
// Syntax: buffer.copy(targetBuffer, targetStart, sourceStart, sourceEnd)
// in the target buffer, the data will be copied beginning at index 4.
// the data will be copied beginning at index 4 and ending at index 10 from the source buffer into the target buffer.
